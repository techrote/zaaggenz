...
def fixture_pack():
    ...
    return {
      # Public lookup label keeps the familiar 12TET spelling; the contract ID obeys the
      # frozen identifier grammar and therefore starts with a letter.
      '12tet-a440':Tuning('tet12-a440',440.,0,2.,tet12,_linear(12,69,69),'12 equal divisions of 2:1','mathematical reference'),
